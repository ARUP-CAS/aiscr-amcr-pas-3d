...
(function (root, factory) {
  ...
  (function ($) {
    ...
    Selectpicker.DEFAULTS = {
      noneSelectedText: 'Vyberte možnost',
      noneResultsText: 'Nenalezena žádná schoda - {0}',
      ...
      header: false,
      liveSearch: false,
      liveSearchPlaceholder: 'Vyhledat...',
      ...
      init: function () {
        ...
        if (that.$element[0].hasAttribute('required')) {
          this.$element.on('invalid' + EVENT_KEY, function () {
            that.$button[0].classList.add('select-invalid');
            ...
            that.$element
              ...
              .on('rendered' + EVENT_KEY, function () {
                ...
                if (this.validity.valid) that.$button[0].classList.remove('select-invalid');
